...
import {CircularProgress, IconButton, ThumbDownIcon, ThumbUpIcon, Typography} from "project-elements";
...
const LikeButton = props => {
  ...
  const likePostPressHandler = async () => {
    try {
      ...
      if (itemType === 'comment') {
        await helpfulComment({
          comment_id: likeItem._id,
          post_id: likeItem.postId,
