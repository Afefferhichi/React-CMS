    ...
    <div className={classes.container}>
      <AppBar position='sticky' style={{background: 'white'}}>
        <Toolbar>
          ...
          <Button id={'startButton'} onClick={() => history.push('/auth')}>Get Started</Button>
        </Toolbar>
      </AppBar>
      <div id='home' className={classes.home}>
        ...
        <p style={{marginTop: '2rem'}}>
          By reconnecting the market stakeholders, 3almadmoon builds a trusted marketplace with strong business
          relationships and secure solutions.
        </p>
      </div>
